...
module.exports = async function newOGLeakEmbed(client, interaction, targetChannel, attachment = '', role1 = 'nobody', role2 = '', role3 = '', leakName, dateOfLeak, altLeakNames = '', price = 'FREE', notes = '') {
...
console.log('Running New OG Leak Embed');
const sendEmbed = new EmbedBuilder()
  .setTitle(`New OG File! - ${leakName}`)
